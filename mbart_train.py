...
def load_model(model_name, _dev=None):
    if model_name == 'mbart':
        _mdl = MBartForConditionalGeneration.from_pretrained(
...
def read_parameters():
	...
	parser.add_argument('-model','--model_name',default='mbart',choices=['mbart','m2m','flant5','mt5','llama3','nllb'],help='Model to train')
